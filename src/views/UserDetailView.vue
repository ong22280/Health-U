    ...
    <div class="container shadow-2xl fade-normal" id="content-user-detail" style="width: 500px">
        <form @submit.prevent="pushInformation">
            ...
            <div class="input-checkbox">
                ...
                <input type="checkbox" id="egg" value="Egg" v-model="dontWantFood" />
                <label for="egg">Egg</label><br />

                <input type="checkbox" id="peanuts" value="Peanuts" v-model="dontWantFood" />
                <label for="peanuts">Peanuts</label><br />

                <input type="checkbox" id="soybean" value="Soybean" v-model="dontWantFood" />
                <label for="soybean">Soybean</label><br />

                <input type="checkbox" id="milk" value="Milk" v-model="dontWantFood" />
                <label for="milk">Milk</label><br />

                <input type="checkbox" id="seafood" value="Seafood" v-model="dontWantFood" />
